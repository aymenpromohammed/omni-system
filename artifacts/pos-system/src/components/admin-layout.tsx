...
import { LogOut, LayoutDashboard, Package, Tags, Receipt, Users, UserCircle, BarChart3, Settings, Printer, FileText, UserCheck, RotateCcw, Wallet, Sliders } from "lucide-react";
...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "بيئة أونكس ERP", href: "/onyx-erp", icon: Sliders },
